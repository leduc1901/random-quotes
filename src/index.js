  ...
  return (
    <>
      ...
      <div className="container">
        ...
        >
          {quotes.map((item, i) => {
            return <Quote text={item} isLoading={isLoading} />;
          })}
        </animated.div>
        <animated.div
          className="info"
          onClick={() => getAuthor(author)}
          style={{ opacity: opacity, position: absolute }}
        >
          <animated.div className="author" style={{ marginLeft: marginLeft }}>
            {author}
          </animated.div>
          <animated.div className="genre" style={{ marginLeft: marginLeft }}>
            {genre}
          </animated.div>
        </animated.div>
      </div>
